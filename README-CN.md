...
<font color=#FFC0CB size=3>本次公测为 删档测试，玩家所获得的卡牌都会在正式上线时弃用。游戏测试过程中获得的代币为主网正式的 GFT。相比上一次测试，这次测试我们做了很多优化。游戏中使用的 gas 费也相比上一次大幅降低了约 50%。执行任何操作请保证钱包里有至少 10 枚 iotx 以确保能够正常玩游戏。</font>
